...
cmi.time_limit_action = "continue,no message";  // RO   "exit,message", "continue,message", "exit,no message",
                                                // "continue no message"
...
cmi.interactions = [];
var cmi_interaction = {};           // RW
cmi_interaction.id = "";
cmi_interaction.type = "";          // "true-false", "choice", "fill-in", "long-fill-in", "matching", "performance",
...
cmi_interaction.objectives = [];
cmi_interaction.correct_responses = [];
